<div class="row mx-2 my-2">
   <div class="card rounded-1 mx-auto">
		<div class="card-header">
            <h4 class="mb-0">Generar Tipo Producto</h4>
    	</div>
       	<div class="card-body">
	    	<form action="<?=url_base?>tipoArticulo/add" class="form-inline" method="POST">
			...
			<!--EMCABEZADO DE TABLA-->
		  	...
		  	<tbody>
			    ...
			    <tr>
			      ...
			      <td><?=$fila->nombre?></td>
			    <td>
			      		<a href="<?=url_base?>tipoArticulo/showMod&id=<?=$fila->id?>" class="btn btn-success" >Modificar</a>
			      </td>
			      <td>

			      		<a class="btn btn-danger" href="<?=url_base?>tipoArticulo/delete&id=<?=$fila->id?>">Borrar</a>
			      </td>
			    </tr>
			    <?php endforeach;?>
			<?php endif;?>
